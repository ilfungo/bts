...
define('_WP_DIR','/home/federico/public_html/');

define('_BTSB_DIR',_WP_DIR.'wp-content/plugins/btsb/');
define('_ORDERS_DIR','/home/bts/file_downloads/');
...
function getWorkList(){
    ...
    foreach ($customer_orders as $customer_order) {
        ...
        foreach ($items as $item) {
            ...
            $workListItemHashName= $pathInput['filename'].'_'.$workListItemFilter.'_'.$item['Vignette'];

            $workListItemTotQty = $workList[$scuola->slug][$classe->slug][$workListItemHashName]['qty']+$item['qty'];

            $workListItemOutput = $workListItemBaseDir.$scuola->slug.'/'.$classe->slug.'/'.$workListItemHashName.'_'.$workListItemTotQty.'.jpg';
