...
class VTMAM_Rules_UI { 
    ...
    //AJAX actions
    add_action( 'wp_ajax_vtmam_ajax_load_variations', array($this, 'vtmam_ajax_load_variations') ); 
    add_action( 'wp_ajax_noprov_vtmam_ajax_load_variations', array($this, 'vtmam_ajax_load_variations') ); 
	}
  ...
  public  function vtmam_add_metaboxes() {
      ...
      add_meta_box('vtmam-max-rule-type', __('Max Rule Type Selection', 'vtmam'), array(&$this, 'vtmam_max_rule_type'), 'vtmam-rule', 'normal', 'high');
  ...
  public function vtmam_error_messages() {     
      ...
      for($i=0; $i < sizeof($vtmam_rule->rule_error_message); $i++) {                                   
   ...
   public    function vtmam_pop_in_select( ) {
       ...
       ?>
        ...
        <div class="column2" id="inpopChoice">       
          ...
          <div id="inpopRadio">
          <?php
           for($i=0; $i < sizeof($vtmam_rule->inpop); $i++) { 
           ?>                 
  ...
  ?>
       ...
       <div class="column2" id="specChoice">
          ...
          <div id="specRadio">
            <span id="Choice-input-span">
                <?php
               for($i=0; $i < sizeof($vtmam_rule->specChoice_in); $i++) { 
               ?>                 
      ...
      <div class="column2" id="amtChoice">
          ...
          <div id="amtRadio">
            <span id="amt-selected">
             <?php
             for($i=0; $i < sizeof($vtmam_rule->amtSelected); $i++) { 
             ?>                 
      ...
      <div class="column2" id="minandmaxChoice">
          ...
          <div id="minandmaxRadio">
            <span id="minandmax-selected">
             <?php
             for($i=0; $i < sizeof($vtmam_rule->minandmaxSelected); $i++) { 
             ?>                 
    ...
    public    function vtmam_max_rule_type( ) {
        ...
        <div class="column1" id="maxRule-typeDescrip">
            <h4><?php _e('Max Rule Type', 'vtmam')?></h4>
      ...
      <div class="column2" id="maxRule-typeChoice">
          <h3><?php _e('Select Max Rule Type', 'vtmam')?></h3>
          <div id="maxRule-typeRadio">
            <span id="maxRule-typeSelected">
             <?php
             for($i=0; $i < sizeof($vtmam_rule->maxRule_typeSelected); $i++) { 
             ?>                                                                                                                                                                                                                                                                                                                                          
