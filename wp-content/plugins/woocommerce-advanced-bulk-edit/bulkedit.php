...
//				return;
	...
	public function showMainPage()
	{
		...
		<br/>
			...
			<td>
			<?php _e( 'Categories', 'woocommerce');?>: </td><td><select id="selcategory" class="makechosen catsel" data-placeholder="choose a category.." multiple style="width:250px;">
			 <option value=""></option>
			<?php
...
//				_e( 'Sale Price', 'wooadvbulkedit');
			...
			<input id="skuvalue" type="text"/>
				...
				<td>
					<select id='tagsparams' class="makechosen paramsvalues" data-placeholder="choose.." multiple style="width:250px;"> <option value=""></option>';
						<?php
						$args = array(
							    'number'     => 99999,
							    'orderby'    => 'slug',
