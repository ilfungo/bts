...
class OCMX_oboxfb_Container
	{
		public function load_container($section_header, $ocmx_tabs = 0, $submit_text = "Save Changes", $note = "") {
			...
			<link href="<?php echo OBOXFBURL; ?>/admin/style.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="wrap">
                        ...
                        <div id="header-block" class="clearfix">
    						<?php if(isset($submit_text) && $submit_text != "") :?>
	                            <input type="submit" class="button-primary" value="<?php _e($submit_text,"ocmx"); ?>" />
								<?php if($_GET["page"] != "ocmx-gallery") : ?>
                                    <input type="button" id="ocmx-reset" class="button-primary" value="<?php _e("Reset","ocmx"); ?>" />
                                <?php endif; ?>
                            <?php endif; ?>
                            ...
                            <?php if(count($ocmx_tabs) >= 1) : 
                                ...
                                foreach($ocmx_tabs as $tab => $taboption) : 
                                    if(isset($taboption["top_button"]) != null) :?>
                                        <div <?php if($selected_tab != $tab_i):?>style="display: none;"<?php endif; ?> id="tab-<?php echo $tab_i; ?>-href">
                                            <a href="<?php echo $taboption["top_button"]["href"]; ?>" id="<?php echo $taboption["top_button"]["id"]; ?>" rel="<?php echo $taboption["top_button"]["rel"]; ?>" class="button-primary"><?php _e($taboption["top_button"]["html"],"ocmx"); ?></a>                                            
                                        </div>
                                <?php endif;
                                    $tab_i++;
                                endforeach;
                        ...
                        <div id="content-block">
                            ...
                            <div class="base-controls clearfix">
                            	<?php if($submit_text != "") :?>
	                                <input type="submit" class="button-primary" value="<?php _e($submit_text,"ocmx"); ?>" />    
									<?php if($_GET["page"] != "ocmx-gallery") : ?>
                                        <input type="button" id="ocmx-reset-1" class="button-primary" value="<?php _e("Reset","ocmx"); ?>" />
                                    <?php endif; ?>                                
                                <?php endif; ?>
                            	<?php if(count($ocmx_tabs) >= 1) : 
									$tab_i = 1;
									foreach($ocmx_tabs as $tab => $taboption) : 
										if(isset($taboption["base_button"]) != null) :?>
