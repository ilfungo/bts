 ...
 */
	class SA_WC_Compatibility {
		...
		public static function wc_get_formatted_name( $product = false ) {
			_deprecated_function( __CLASS__.'::wc_get_formatted_name', '1.2', 'SA_WC_Compatibility_2_2::get_formatted_product_name' );
			if ( self::is_wc_21() ) {
		...
		public static function is_wc_21() {
			_deprecated_function( __CLASS__.'::is_wc_21', '1.2', 'SA_WC_Compatibility_2_2::is_wc_gte_21' );
