							...
							<td class="product-name">
								<div class="imageName">
									...
									if ( $_product && ! $_product->is_visible() )
										...
										echo apply_filters( 'woocommerce_order_item_name', sprintf( '<a href="%s" target="_blank">%s</a>', get_permalink( $_product->post->post_parent ) , $item['name'] ), $item );
									//prendo il post name del parent del post e lo stampo
										$postParentName = get_the_title($_product->get_parent());
									echo $postParentName;
									?>
									</div>
								<div class="imagePreview">
									<?php
									//aggiungo preview foto
								...
								<?php if(isset($_product->post->post_parent))
